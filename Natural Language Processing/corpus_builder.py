...
'''
Description: This script will convert the sentences (with emoji) to text_with_emoji, text2emoji or text_without_emoji. 
             Then, the result will be converted to triplets JSON format
'''
...
def convert(emoji_choices:str, truncation:bool, directory:str, output_path:str):
    ...
    #directory = '/Users/chinpangchia/Library/Containers/com.tencent.WeWorkMac/Data/WeDrive/腾讯/NLP-Task-Data/等待验收/Aspect Sentiment/'
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_path",
        default="/Users/{user_environment}/Desktop/Text".format(user_environment = user_environment),
        required=False,
        type=str,
